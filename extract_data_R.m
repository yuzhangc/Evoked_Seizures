...
% Column 21 - Behavioral Seizure Scale

col21 = num2cell(sz_parameters(:,21));

beginning_data = table(col1,col2,col3,col4,col5,col6,col7,col8,col9,col10,col11,col12,...
    col13,col14,col15,col16,col17,col18,col19,col20,col21,'VariableNames',["Animal","Epileptic","Gender","Age",...
